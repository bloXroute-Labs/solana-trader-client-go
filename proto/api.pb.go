...
type GetSwapsStreamResponse struct {
	...
	Slot      int64  `protobuf:"varint,1,opt,name=slot,proto3" json:"slot,omitempty"`
	Market    string `protobuf:"bytes,2,opt,name=market,proto3" json:"market,omitempty"`
	InAmount  uint64 `protobuf:"varint,3,opt,name=inAmount,proto3" json:"inAmount,omitempty"`
	OutAmount uint64 `protobuf:"varint,4,opt,name=outAmount,proto3" json:"outAmount,omitempty"`
}
...
var file_api_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x50, 0x61, 0x69, 0x72, 0x73, 0x22, 0x31, 0x0a, 0x15, 0x47, 0x65,
	...
	0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x73, 0x22, 0x7e, 0x0a,
	...
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x73, 0x6c, 0x6f, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x6d,
	...
	0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x69, 0x6e, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12,
...
var file_api_proto_depIdxs = []int32{
	...
	93,  // 71: api.GetPriceResponse.tokenPrices:type_name -> api.TokenPrice
	7,   // 72: api.TokenPrice.project:type_name -> api.Project
	95,  // 73: api.GetPoolReservesStreamResponse.reserves:type_name -> api.PoolReserves
	...
	93,  // 77: api.GetPricesStreamResponse.price:type_name -> api.TokenPrice
	11,  // 78: api.GetMarketsResponse.MarketsEntry.value:type_name -> api.Market
	91,  // 79: api.Api.GetPrice:input_type -> api.GetPriceRequest
	...
	96,  // 112: api.Api.GetPoolReservesStream:input_type -> api.GetPoolReservesStreamRequest
	97,  // 113: api.Api.GetPricesStream:input_type -> api.GetPricesStreamRequest
	88,  // 114: api.Api.GetSwapsStream:input_type -> api.GetSwapsStreamRequest
	92,  // 115: api.Api.GetPrice:output_type -> api.GetPriceResponse
	10,  // 116: api.Api.GetMarkets:output_type -> api.GetMarketsResponse
	83,  // 117: api.Api.GetPools:output_type -> api.GetPoolsResponse
	13,  // 118: api.Api.GetTickers:output_type -> api.GetTickersResponse
	16,  // 119: api.Api.GetKline:output_type -> api.GetKlineResponse
	20,  // 120: api.Api.GetOrderbook:output_type -> api.GetOrderbookResponse
	23,  // 121: api.Api.GetTrades:output_type -> api.GetTradesResponse
	69,  // 122: api.Api.GetQuotes:output_type -> api.GetQuotesResponse
	26,  // 123: api.Api.GetServerTime:output_type -> api.GetServerTimeResponse
	81,  // 124: api.Api.GetRecentBlockHash:output_type -> api.GetRecentBlockHashResponse
	28,  // 125: api.Api.GetAccountBalance:output_type -> api.GetAccountBalanceResponse
	32,  // 126: api.Api.PostOrder:output_type -> api.PostOrderResponse
	51,  // 127: api.Api.PostSubmit:output_type -> api.PostSubmitResponse
	53,  // 128: api.Api.PostSubmitBatch:output_type -> api.PostSubmitBatchResponse
	35,  // 129: api.Api.PostCancelOrder:output_type -> api.PostCancelOrderResponse
	35,  // 130: api.Api.PostCancelByClientOrderID:output_type -> api.PostCancelOrderResponse
	38,  // 131: api.Api.PostCancelAll:output_type -> api.PostCancelAllResponse
	32,  // 132: api.Api.PostReplaceByClientOrderID:output_type -> api.PostOrderResponse
	32,  // 133: api.Api.PostReplaceOrder:output_type -> api.PostOrderResponse
	40,  // 134: api.Api.PostSettle:output_type -> api.PostSettleResponse
	74,  // 135: api.Api.PostTradeSwap:output_type -> api.TradeSwapResponse
	43,  // 136: api.Api.GetOrders:output_type -> api.GetOrdersResponse
	55,  // 137: api.Api.GetOpenOrders:output_type -> api.GetOpenOrdersResponse
	57,  // 138: api.Api.GetOrderByID:output_type -> api.GetOrderByIDResponse
	61,  // 139: api.Api.GetUnsettled:output_type -> api.GetUnsettledResponse
	74,  // 140: api.Api.PostRouteTradeSwap:output_type -> api.TradeSwapResponse
	62,  // 141: api.Api.GetOrderbooksStream:output_type -> api.GetOrderbooksStreamResponse
	63,  // 142: api.Api.GetTickersStream:output_type -> api.GetTickersStreamResponse
	65,  // 143: api.Api.GetMarketDepthStream:output_type -> api.GetMarketDepthStreamResponse
	67,  // 144: api.Api.GetTradesStream:output_type -> api.GetTradesStreamResponse
	46,  // 145: api.Api.GetOrderStatusStream:output_type -> api.GetOrderStatusStreamResponse
	81,  // 146: api.Api.GetRecentBlockHashStream:output_type -> api.GetRecentBlockHashResponse
	86,  // 147: api.Api.GetQuotesStream:output_type -> api.GetQuotesStreamResponse
	94,  // 148: api.Api.GetPoolReservesStream:output_type -> api.GetPoolReservesStreamResponse
	98,  // 149: api.Api.GetPricesStream:output_type -> api.GetPricesStreamResponse
	89,  // 150: api.Api.GetSwapsStream:output_type -> api.GetSwapsStreamResponse
