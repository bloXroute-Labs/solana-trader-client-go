...
var file_api_proto_rawDesc = []byte{
	...
	0x0a, 0x05, 0x53, 0x54, 0x45, 0x50, 0x33, 0x10, 0x03, 0x32, 0xcc, 0x21, 0x0a, 0x03, 0x41, 0x70,
	...
	0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x30, 0x01, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x62, 0x6c, 0x6f, 0x58, 0x72, 0x6f, 0x75, 0x74, 0x65,
	0x2d, 0x4c, 0x61, 0x62, 0x73, 0x2f, 0x73, 0x65, 0x72, 0x75, 0x6d, 0x2d, 0x61, 0x70, 0x69, 0x2f,
...
var file_api_proto_depIdxs = []int32{
	...
	7,  // 69: api.Api.GetMarkets:output_type -> api.GetMarketsResponse
	10, // 70: api.Api.GetTickers:output_type -> api.GetTickersResponse
	13, // 71: api.Api.GetKline:output_type -> api.GetKlineResponse
	17, // 72: api.Api.GetOrderbook:output_type -> api.GetOrderbookResponse
	20, // 73: api.Api.GetTrades:output_type -> api.GetTradesResponse
	23, // 74: api.Api.GetServerTime:output_type -> api.GetServerTimeResponse
	25, // 75: api.Api.GetAccountBalance:output_type -> api.GetAccountBalanceResponse
	29, // 76: api.Api.PostOrder:output_type -> api.PostOrderResponse
	45, // 77: api.Api.PostSubmit:output_type -> api.PostSubmitResponse
	32, // 78: api.Api.PostCancelOrder:output_type -> api.PostCancelOrderResponse
	32, // 79: api.Api.PostCancelByClientOrderID:output_type -> api.PostCancelOrderResponse
	34, // 80: api.Api.PostCancelAll:output_type -> api.PostCancelAllResponse
	29, // 81: api.Api.PostReplaceByClientOrderID:output_type -> api.PostOrderResponse
	29, // 82: api.Api.PostReplaceOrder:output_type -> api.PostOrderResponse
	36, // 83: api.Api.PostSettle:output_type -> api.PostSettleResponse
	39, // 84: api.Api.GetOrders:output_type -> api.GetOrdersResponse
	47, // 85: api.Api.GetOpenOrders:output_type -> api.GetOpenOrdersResponse
	49, // 86: api.Api.GetOrderByID:output_type -> api.GetOrderByIDResponse
	53, // 87: api.Api.GetUnsettled:output_type -> api.GetUnsettledResponse
	54, // 88: api.Api.GetOrderbooksStream:output_type -> api.GetOrderbooksStreamResponse
	55, // 89: api.Api.GetTickersStream:output_type -> api.GetTickersStreamResponse
	57, // 90: api.Api.GetMarketDepthStream:output_type -> api.GetMarketDepthStreamResponse
	59, // 91: api.Api.GetTradesStream:output_type -> api.GetTradesStreamResponse
	42, // 92: api.Api.GetOrderStatusStream:output_type -> api.GetOrderStatusStreamResponse
	61, // 93: api.Api.GetRecentBlockHashStream:output_type -> api.GetRecentBlockHashResponse
