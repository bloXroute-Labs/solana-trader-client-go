...
var file_api_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x65, 0x52, 0x06, 0x74, 0x72, 0x61, 0x64, 0x65, 0x73, 0x22, 0x1b, 0x0a, 0x19, 0x47,
	0x65, 0x74, 0x52, 0x65, 0x63, 0x65, 0x6e, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x61, 0x73,
	0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x3a, 0x0a, 0x1a, 0x47, 0x65, 0x74, 0x52,
	0x65, 0x63, 0x65, 0x6e, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x61, 0x73, 0x68, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x48,
	0x61, 0x73, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x62, 0x6c, 0x6f, 0x63, 0x6b,
	0x48, 0x61, 0x73, 0x68, 0x2a, 0x2d, 0x0a, 0x0c, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x53, 0x74,
	...
	0x0a, 0x05, 0x53, 0x54, 0x45, 0x50, 0x33, 0x10, 0x03, 0x32, 0xb0, 0x22, 0x0a, 0x03, 0x41, 0x70,
	...
	0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x30, 0x01, 0x12, 0x62, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x52,
	...
	0x0b, 0x92, 0x41, 0x08, 0x0a, 0x06, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x42, 0x29, 0x5a, 0x27,
...
var file_api_proto_goTypes = []interface{}{
	...
	nil,                                      // 62: api.GetMarketsResponse.MarketsEntry
	(*timestamp.Timestamp)(nil),              // 63: google.protobuf.Timestamp
}
var file_api_proto_depIdxs = []int32{
	62, // 0: api.GetMarketsResponse.markets:type_name -> api.GetMarketsResponse.MarketsEntry
	0,  // 1: api.Market.status:type_name -> api.MarketStatus
	11, // 2: api.GetTickersResponse.tickers:type_name -> api.Ticker
	63, // 3: api.GetKlineRequest.from:type_name -> google.protobuf.Timestamp
	63, // 4: api.GetKlineRequest.to:type_name -> google.protobuf.Timestamp
	63, // 5: api.GetKlineResponse.timestamp:type_name -> google.protobuf.Timestamp
	14, // 6: api.GetKlineResponse.candles:type_name -> api.Candle
	63, // 7: api.Candle.startTime:type_name -> google.protobuf.Timestamp
	63, // 8: api.Candle.updateTime:type_name -> google.protobuf.Timestamp
	...
	63, // 22: api.GetOrdersRequest.from:type_name -> google.protobuf.Timestamp
	...
	63, // 27: api.Order.createdAt:type_name -> google.protobuf.Timestamp
	...
	60, // 68: api.Api.GetRecentBlockHashStream:input_type -> api.GetRecentBlockHashRequest
	60, // 69: api.Api.GetRecentBlockHash:input_type -> api.GetRecentBlockHashRequest
	7,  // 70: api.Api.GetMarkets:output_type -> api.GetMarketsResponse
	10, // 71: api.Api.GetTickers:output_type -> api.GetTickersResponse
	13, // 72: api.Api.GetKline:output_type -> api.GetKlineResponse
	17, // 73: api.Api.GetOrderbook:output_type -> api.GetOrderbookResponse
	20, // 74: api.Api.GetTrades:output_type -> api.GetTradesResponse
	23, // 75: api.Api.GetServerTime:output_type -> api.GetServerTimeResponse
	25, // 76: api.Api.GetAccountBalance:output_type -> api.GetAccountBalanceResponse
	29, // 77: api.Api.PostOrder:output_type -> api.PostOrderResponse
	45, // 78: api.Api.PostSubmit:output_type -> api.PostSubmitResponse
	32, // 79: api.Api.PostCancelOrder:output_type -> api.PostCancelOrderResponse
	32, // 80: api.Api.PostCancelByClientOrderID:output_type -> api.PostCancelOrderResponse
	34, // 81: api.Api.PostCancelAll:output_type -> api.PostCancelAllResponse
	29, // 82: api.Api.PostReplaceByClientOrderID:output_type -> api.PostOrderResponse
	29, // 83: api.Api.PostReplaceOrder:output_type -> api.PostOrderResponse
	36, // 84: api.Api.PostSettle:output_type -> api.PostSettleResponse
	39, // 85: api.Api.GetOrders:output_type -> api.GetOrdersResponse
	47, // 86: api.Api.GetOpenOrders:output_type -> api.GetOpenOrdersResponse
	49, // 87: api.Api.GetOrderByID:output_type -> api.GetOrderByIDResponse
	53, // 88: api.Api.GetUnsettled:output_type -> api.GetUnsettledResponse
	54, // 89: api.Api.GetOrderbooksStream:output_type -> api.GetOrderbooksStreamResponse
	55, // 90: api.Api.GetTickersStream:output_type -> api.GetTickersStreamResponse
	57, // 91: api.Api.GetMarketDepthStream:output_type -> api.GetMarketDepthStreamResponse
	59, // 92: api.Api.GetTradesStream:output_type -> api.GetTradesStreamResponse
	42, // 93: api.Api.GetOrderStatusStream:output_type -> api.GetOrderStatusStreamResponse
	61, // 94: api.Api.GetRecentBlockHashStream:output_type -> api.GetRecentBlockHashResponse
	61, // 95: api.Api.GetRecentBlockHash:output_type -> api.GetRecentBlockHashResponse
