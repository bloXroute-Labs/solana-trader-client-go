...
type ApiClient interface {
	...
	PostCancelOrderByClientID(ctx context.Context, in *PostCancelOrderByClientIDRequest, opts ...grpc.CallOption) (*PostCancelOrderResponse, error)
...
func (c *apiClient) PostCancelOrderByClientID(ctx context.Context, in *PostCancelOrderByClientIDRequest, opts ...grpc.CallOption) (*PostCancelOrderResponse, error) {
	out := new(PostCancelOrderResponse)
	err := c.cc.Invoke(ctx, "/api.Api/PostCancelOrderByClientID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiClient) GetOrderbookStream(ctx context.Context, in *GetOrderBookRequest, opts ...grpc.CallOption) (Api_GetOrderbookStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Api_ServiceDesc.Streams[0], "/api.Api/GetOrderbookStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &apiGetOrderbookStreamClient{stream}
...
type Api_GetOrderbookStreamClient interface {
	Recv() (*GetOrderbookStreamResponse, error)
	grpc.ClientStream
}

type apiGetOrderbookStreamClient struct {
	grpc.ClientStream
}

func (x *apiGetOrderbookStreamClient) Recv() (*GetOrderbookStreamResponse, error) {
	m := new(GetOrderbookStreamResponse)
...
func (c *apiClient) GetTradeStream(ctx context.Context, in *GetTradesRequest, opts ...grpc.CallOption) (Api_GetTradeStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Api_ServiceDesc.Streams[3], "/api.Api/GetTradeStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &apiGetTradeStreamClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Api_GetTradeStreamClient interface {
	Recv() (*GetTradesStreamResponse, error)
	grpc.ClientStream
}

type apiGetTradeStreamClient struct {
	grpc.ClientStream
}

func (x *apiGetTradeStreamClient) Recv() (*GetTradesStreamResponse, error) {
...
type ApiServer interface {
	...
	PostCancelOrderByClientID(context.Context, *PostCancelOrderByClientIDRequest) (*PostCancelOrderResponse, error)
...
func (UnimplementedApiServer) PostCancelOrderByClientID(context.Context, *PostCancelOrderByClientIDRequest) (*PostCancelOrderResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PostCancelOrderByClientID not implemented")
}
...
func (UnimplementedApiServer) GetTradeStream(*GetTradesRequest, Api_GetTradeStreamServer) error {
...
func _Api_PostCancelOrderByClientID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PostCancelOrderByClientIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiServer).PostCancelOrderByClientID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.Api/PostCancelOrderByClientID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiServer).PostCancelOrderByClientID(ctx, req.(*PostCancelOrderByClientIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Api_GetOrderbookStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GetOrderBookRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(ApiServer).GetOrderbookStream(m, &apiGetOrderbookStreamServer{stream})
}

type Api_GetOrderbookStreamServer interface {
	Send(*GetOrderbookStreamResponse) error
	grpc.ServerStream
}

type apiGetOrderbookStreamServer struct {
	grpc.ServerStream
}

func (x *apiGetOrderbookStreamServer) Send(m *GetOrderbookStreamResponse) error {
...
func _Api_GetTradeStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GetTradesRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(ApiServer).GetTradeStream(m, &apiGetTradeStreamServer{stream})
}

type Api_GetTradeStreamServer interface {
	Send(*GetTradesStreamResponse) error
	grpc.ServerStream
}

type apiGetTradeStreamServer struct {
	grpc.ServerStream
}

func (x *apiGetTradeStreamServer) Send(m *GetTradesStreamResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var Api_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PostCancelOrderByClientID",
			Handler:    _Api_PostCancelOrderByClientID_Handler,
		},
		{
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _Api_GetOrderbookStream_Handler,
			ServerStreams: true,
		},
		{
		...
		},
		{
			...
			Handler:       _Api_GetTradeStream_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "api.proto",
