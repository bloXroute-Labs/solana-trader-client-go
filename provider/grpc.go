...
func (g *GRPCClient) GetBundleResult(ctx context.Context, uuid string) (*pb.GetBundleResultsResponse, error) {
	return g.apiClient.GetBundleResultV2(ctx, &pb.GetBundleResultsRequest{Uuid: uuid})
}
