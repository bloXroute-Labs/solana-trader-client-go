...
type HTTPClientTraderAPI interface {
	...
	GetPumpFunAmmQuotes(ctx context.Context, request *pb.GetPumpFunAmmQuotesRequest) (*pb.GetPumpFunAmmQuotesResponse, error)
	PostPumpFunAmmSwap(ctx context.Context, request *pb.PostPumpFunAmmSwapRequest) (*pb.PostPumpFunAmmSwapResponse, error)
	...
	SubmitPostPumpFunAmmSwap(ctx context.Context, request *pb.PostPumpFunAmmSwapRequest) (string, error)
	...
	SubmitRaydiumSwapInstructions(ctx context.Context, request *pb.PostRaydiumSwapInstructionsRequest, useBundle bool, opts SubmitOpts) (string, error)
